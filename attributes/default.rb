id = 'rcc-2017-oracle-checker'

default[id]['basedir'] = '/var/themis/finals/checker/oracle'
default[id]['bitbucket_repository'] = 'VolgaCTF/rcc-2017-oracle-checker'
default[id]['revision'] = 'master'
default[id]['user'] = 'vagrant'
default[id]['group'] = 'vagrant'

default[id]['debug'] = false
default[id]['service_alias'] = 'oracle'
